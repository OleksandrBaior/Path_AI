...
class Sign_up {
  ...
  verifyInvalidValues(list: Array<string>, field: Cypress.Chainable<JQuery<HTMLElement>>): void {
    list.forEach((element) => {
      field.type(element);
      field.should('have.css', 'border-color', constants.styleElement.errorBorder);
